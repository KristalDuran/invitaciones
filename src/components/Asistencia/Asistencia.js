...
const Asistencia = () => {
    ...
    return (
      <div className='asistencia'>
        ...
        <p className='asistenciaInfo'>Saber que estarás con nosotros este día tan especial es muy importante, por esto no olvides confirmar tu asitencia antes del <b>30 de Septiembre.</b></p>
        <Form />
